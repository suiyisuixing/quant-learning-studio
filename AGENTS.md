...
个人提示词一次给齐全部任务，不按周安排。按 prompts/EXECUTE_TO_COMPLETION.md 连续推进到本人全部成果、验证和交接；不能只交计划或首个小 PR 就结束。四名开发者先填写覆盖全部范围的 plans/<role>/PLAN.md，Yu 确认精确 PLAN 与实际路径后才实施；已有批准内的步骤不重复确认。公共接口、权限、CI、依赖锁、公共入口由 Yu 控制。Xiangze（历史别名 Xingze）是同一位开发者，负责案例/内容模块代码与测试。
