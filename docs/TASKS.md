...
四名开发者先本人 PLAN 后实施；后三人可交文件/Issue，不要求 GitHub。角色 Issue 更新同一编号，保留原有讨论。R3 分支文件需 Yu 最终合并，不能当作 main 已激活。
...
|Yifan.Mao|资料/真人测试计划、批次和复测|[#6](https://github.com/suiyisuixing/quant-learning-studio/issues/6)|
|Guanjie.Xue|资料/真人测试计划、批次和复测|[#7](https://github.com/suiyisuixing/quant-learning-studio/issues/7)|
|Yuntao.Min|资料/真人测试计划、批次和复测|[#8](https://github.com/suiyisuixing/quant-learning-studio/issues/8)|
